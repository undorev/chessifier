export const it_IT = {
  translation: {
    ...
    "Home.Card.Learn.Title": "Impara gli scacchi",
    "Home.Card.Learn.Desc": "Lezioni interattive per imparare gli scacchi dalle basi fino alle strategie avanzate",
    "Home.Card.Learn.Button": "Inizia a imparare",
    ...
    "Home.Card.PlayChess.Title": "Gioca una partita",
    "Home.Card.PlayChess.Desc": "Sfida un motore o un amico",
    "Home.Card.PlayChess.Button": "Gioca ora",
    "Home.Card.AnalysisBoard.Title": "Scacchiera di analisi",
    "Home.Card.AnalysisBoard.Desc": "Analizza una partita o una posizione",
    "Home.Card.AnalysisBoard.Button": "Apri",
    ...
    "Home.Card.Puzzle.Title": "Puzzle tattici",
    "Home.Card.Puzzle.Desc": "Affina le tue abilità di scacchi con puzzle tattici e migliora il riconoscimento dei pattern",
    "Home.Card.Puzzle.Button": "Risolvi",
    
    "Home.Card.Analyze.Title": "Analisi della scacchiera",
    "Home.Card.Analyze.Desc": "Analizza posizioni, partite e varianti con potenti motori di scacchi.",
    "Home.Card.Analyze.Button": "Analizza",
    "Home.Card.Database.Title": "Accesso al database",
    "Home.Card.Database.Desc": "Esplora vasti database di scacchi e studia le partite dei maestri per approfondire la tua comprensione.",
    "Home.Card.Database.Button": "Sfoglia",
    "Home.Card.Engine.Title": "Integrazione motori",
    "Home.Card.Engine.Desc": "Aggiungi e gestisci più motori di scacchi per personalizzare la tua configurazione di analisi e migliorare la flessibilità.",
    "Home.Card.Engine.Button": "Gestisci",
    "Home.Card.Account.Title": "Account",
    "Home.Card.Account.Desc": "Importa le tue partite e statistiche collegando il tuo account Chess.com o Lichess per un'analisi personalizzata.",
    "Home.Card.Account.Button": "Connetti",
    "Home.Card.Import.Title": "Importa",
    "Home.Card.Import.Desc": "Carica e modifica file PGN per analizzare le tue partite o studiare posizioni specifiche con pieno controllo.",
    "Home.Card.Import.Button": "Importa",
    ...
    "Engines.Remove.Message":
      "Sei sicuro di voler rimuovere questo motore da Pawn Appétit?",
    ...
    "Settings.Anarchy.EnPassant.Desc":
      "Ti obbliga a giocare En Passant, se è una mossa legale.",
