export const pt_PT = {
  translation: {
    ...
    "Engines.Remove.Message": "Tens a certeza que queres remover este engine do Chessifier?",
    ...
    "Settings.Anarchy.ForcedChessifier.Desc": "Obriga jogar Chessifier, caso seja uma jogada legal.",
