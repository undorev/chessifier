export const es_ES = {
  translation: {
    ...
    "Engines.Remove.Message": "¿Está seguro de que desea eliminar este motor de Chessifier?",
    ...
    "Settings.Anarchy.ForcedChessifier.Desc": "Forzar a jugar Chessifier, si es un movimiento legal.",
